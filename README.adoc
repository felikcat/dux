...
.If you're going to use Dux, one rule to keep in mind:
...
I try to test once a week with default settings.
- This installer is a way to install Arch Linux faster, and in a higher-quality way than the majority of tinkerers can achieve.
