...
WARNING: Do not use. I've switched to NixOS and this is as good as dead. +
If you're interested in writing an Arch Linux installer in Bash however, this might be a good learning resource.
